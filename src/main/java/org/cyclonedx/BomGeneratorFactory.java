...
import org.cyclonedx.generators.xml.BomXmlGenerator16;
...
public class BomGeneratorFactory {
    ...
    @Deprecated
    public static BomXmlGenerator create(Version version, Bom bom) {
    ...
    public static BomXmlGenerator createXml(Version version, Bom bom) {
        switch (version) {
            ...
            default:
                return new BomXmlGenerator16(bom);
        }
    }

    public static BomJsonGenerator createJson(final Version version, Bom bom) {
        switch (version) {
            case VERSION_12:
            ...
            default:
                return new BomJsonGenerator16(bom);
        }
    }
}
